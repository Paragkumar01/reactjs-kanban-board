...
function App() {
  ...
  const priorityLabels = {
    0: (
      ...
      <img src="https://cdn-icons-png.flaticon.com/128/8521/8521515.png" className='user-pic' alt="No Priority" />  No Priority
      </div>
    ),
    2:(
      <div className="user-label">
      <img src="https://cdn-icons-png.flaticon.com/128/2386/2386473.png" className='user-pic' alt="Low" />  Low
      </div>
    ),
    3:(
      <div className="user-label">
      <img src="https://cdn-icons-png.flaticon.com/128/445/445217.png" className='user-pic' alt="Medium" />  Medium
      </div>
    ), 
    4:(
      <div className="user-label">
      <img src="https://cdn-icons-png.flaticon.com/128/608/608336.png"  className='user-pic' alt="High" />  High
      </div>
    ),  
    1:(
      <div className="user-label">
      <img src="https://cdn-icons-png.flaticon.com/128/5619/5619095.png" className='user-pic' alt="Urgent" />  Urgent
      </div>
    )
  };
